---
title: Image Filters and Fourier Practice
...
# Filters and Fourier in Computer Vision

- [link to quick start guide](https://medium.com/@akashsingh9303/image-processing-using-convolution-kernels-in-python-a-practical-guide-2da3252b033a)
- [wavelet thresholding in pywt](https://pywavelets.readthedocs.io/en/latest/ref/thresholding-functions.html#thresholding)
...
## Convolution
 - combines two sets of information
 - applying a *filter* 

## Image kernels

- kirsch taken from [here](https://en.wikipedia.org/wiki/Kirsch_operator)

## Wavelet transform

 - time and space information
 - *pywt* is *loved* by computer vision engineers
 - **Image** *compresion, denoising* and *feature extraction*
 - isolate features at different resolutions (*rhythm* and *nuances*)
...
tCA = pywt.threshold(CA, 5, "soft")

tcH = pywt.threshold(cH, 5, "soft")

test = pywt.idwt2((tCA,(tcH,cV,cD)), 'haar')
